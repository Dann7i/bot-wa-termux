...
export async function eksekusi(danSaiyan, pesan) {
  try {
    ...
    await danSaiyan.sendMessage(pesan.chatId, { react: { text: global.dan.emojicuy.wait, key: pesan.key } });
    ...
    await danSaiyan.sendMessage(pesan.chatId, { image: imageBuffer, caption: "Nih hasilnya, keren kan? " }, { quoted: pesan });
  } catch (error) {
    ...
    await danSaiyan.sendMessage(pesan.chatId, { text: "inimah erronya pas bikin gambar, coba lagi yaa bro.." }, { quoted: pesan });
  }
}
